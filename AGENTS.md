...
- **Go-signer npm conformance publish** (ADR 0077 confirmation): before P06, complete a controlled
  real npm publish with registry attestation read-back and pacote consumer verification.
