...
| [SLSA provenance v1](slsa-provenance-v1.md)                                 | Common in-toto Statement and SLSA v1 predicate contract      | 0002, 0003, 0028, 0029, 0035, 0037, 0042, 0055, 0061, 0064                             |
...
| [JS/TS npm build and pack](js-ts-npm-build-pack.md)                         | Package selection, package manager rules, install/build/pack | 0014, 0015, 0016, 0017, 0018, 0019, 0023, 0027, 0033, 0056, 0063, 0064                 |
| [JS/TS npm provenance and publish](js-ts-npm-provenance-publish.md)         | Provenance, three-job publish graph, npm publish             | 0024, 0025, 0028, 0029, 0030, 0035, 0036, 0037, 0052, 0055–0057, 0059–0061, 0063, 0064 |
...
| [Verification policy and fixtures](verification-policy-and-fixtures.md)     | Verifier policy, fixture taxonomy, reference commands        | 0028, 0029, 0030, 0036, 0037, 0049, 0050, 0051, 0052–0054, 0056–0064                   |
