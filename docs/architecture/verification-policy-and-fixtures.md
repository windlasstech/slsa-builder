...
severity `error` and exit code `1`; a fixture that proves its condition but emits another primary ID
fails with `windlass.verify.error.diagnostics-contract-invalid`.
